...
bush_number = int(input('Введите номер куста:')) - 1

sum_berries = garden_bed [bush_number - 1] + garden_bed [bush_number] + garden_bed[bush_number + 1]

print ( f"Макс. кол-во ягод  {sum_berries}  , собрано для куста {bush_number + 1} ")